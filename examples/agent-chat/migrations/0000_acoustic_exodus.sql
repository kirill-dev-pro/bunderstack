...
--> statement-breakpoint
CREATE UNIQUE INDEX `agent_threads_userId_unique` ON `agent_threads` (`userId`);--> statement-breakpoint
...
CREATE UNIQUE INDEX `bjq_dedupe` ON `_bunderstack_jobs` (`type`,`dedupe_key`);