...
The package also ships `llms.txt`, a dense plain-text reference for the whole
framework at `node_modules/bunderstack/llms.txt` and at
[/llms.txt](/llms.txt). Both skills point at it.
