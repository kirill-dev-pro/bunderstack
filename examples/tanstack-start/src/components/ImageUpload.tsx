...
export function thumbnailUrl(fileId: string, opts?: { w?: number; h?: number; format?: 'webp' | 'jpeg' }) {
...
export function ImageUpload({ label, hint, accept = 'image/*', onUploaded, disabled }: ImageUploadProps) {
